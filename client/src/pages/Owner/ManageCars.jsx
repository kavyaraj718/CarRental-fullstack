          ...
          {cars.map((car, index) => (
            <tr key={index} className='border-t border-borderColor'>
              ...
              <td className='p-3 max:md-hidden'>
                <span className={`px-3 py-1 rounded-full text-xs ${car.isAvaliable ? 'bg-green-100 text-green-500' : 'bg-red-100 bg-red=500'}`}>{car.isAvaliable ? "Available" : "Unavailable"}</span>
              </td>
